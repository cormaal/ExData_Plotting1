...
## Line 34 opens the file device with specified file name and dimensions
## Line 36 sets up the graphics device to add four plots row-wise in a 2x2 matrix
## Line 38 plots the first line graph (top left)
## Line 40 plots the second line graph (top right)
## Lines 42-45 plot the third line graph (bottom left)
## Line 47 plots the fourth line graph (bottom right)
## Line 49 explicitly closes the graphics device
## Line 51 returns the graphics device to the 1x1 display
